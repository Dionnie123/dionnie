...
function _dionnietheme_assets()
{
    ...
    wp_enqueue_style('dionnietheme-stylesheet',  get_template_directory_uri() . '/dist/css/bundle.css'); //this must be the last css to be added
    wp_enqueue_script('dionnietheme-scripts',  get_template_directory_uri() . '/dist/js/bundle.js', array('jquery'), '1.0.0', true); //this must be the last js to be added
}
