...
{
    wp_enqueue_style('_themename-stylesheet',  get_template_directory_uri() . '/dist/css/admin.css'); //this must be the last css to be added
    wp_enqueue_script('_themename-scripts',  get_template_directory_uri() . '/dist/js/admin.js', array('jquery'), '1.0.0', true); //this must be the last js to be added
}
