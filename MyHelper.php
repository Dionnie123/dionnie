...
class MyHelper
{
    ...
    static function is_string_in_array($needle, $haystack = array())
    {
    ...
    public static  function get_value($param_name, $allowed_values = array(), $default_value = '')
    {
        ...
        if (isset($_GET[$param_name])) {
            ...
            if (!empty($allowed_values)) {
                ...
                if ($foobar->is_string_in_array($_GET[$param_name], $allowed_values)) {
    ...
    public static function bootstrap_pagination($wp_query = false, $echo = true, $args = array())
    {
        ...
        $x = array_replace($default, $args);
        $listString = paginate_links($x);


      //  util::dump($listString);
